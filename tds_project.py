...
if page == 'Group Detail':
    ...
    st.header("Section : TC1V / TT2V")
    st.header("Group Members :")
    st.subheader("Tan Kuang Chen 1171103939 (Group Leader)")
    st.subheader("Chan Jun Yang 1171103573")
    st.subheader("Sashrreik Menon 1171103922")
